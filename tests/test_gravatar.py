...
class GravatarImageTestCase(unittest.TestCase):
    ...
    def test_image_size(self):
        ...
        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?size=24"
        )
    ...
    def test_filetype_extension(self):
        ...
        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346.jpg"
        )
    ...
    def test_rating(self):
        ...
        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=g"
        )
        result = self.g.get_image(rating="g")
        self.assertEqual(image_url, result)

        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=pg"
        )
        result = self.g.get_image(rating="pg")
        self.assertEqual(image_url, result)

        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=r"
        )
        result = self.g.get_image(rating="r")
        self.assertEqual(image_url, result)

        image_url = (
            "https://www.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=x"
        )
