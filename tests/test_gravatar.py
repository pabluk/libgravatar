...
class GravatarImageTestCase(unittest.TestCase):
    ...
    def test_image_size(self):
        ...
        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?size=24'
    ...
    def test_filetype_extension(self):
        ...
        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346.jpg'
        result = self.g.get_image(filetype_extension=True)
        self.assertEqual(image_url, result)

    def test_default(self):
        """Test default parameter."""
        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?default=monsterid'
        result = self.g.get_image(default='monsterid')
        self.assertEqual(image_url, result)

        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?default=http%3A%2F%2Fexample.com%2Fimages%2Favatar.jpg'
    ...
    def test_forcedefault(self):
        ...
        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?forcedefault=y'
    ...
    def test_rating(self):
        ...
        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=g'
        result = self.g.get_image(rating='g')
        self.assertEqual(image_url, result)

        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=pg'
        result = self.g.get_image(rating='pg')
        self.assertEqual(image_url, result)

        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=r'
        result = self.g.get_image(rating='r')
        self.assertEqual(image_url, result)

        image_url = 'https://secure.gravatar.com/avatar/0bc83cb571cd1c50ba6f3e8a78ef1346?rating=x'
...
class GravatarProfileTestCase(unittest.TestCase):
    ...
    def test_without_params(self):
        ...
        profile_url = 'https://secure.gravatar.com/0bc83cb571cd1c50ba6f3e8a78ef1346'
